...
import { SiblingLine, MarriageLine, ConsanguineousLine, SeparationLine, TwinsLine, IdenticalTwinsLine } from "./Lines"
...
export default class ConnectionsManager {
    ...
    drawIdenticalTwinsLines(parent, twinA, twinB) {
        ...
        if(!parent.marriagePartner) {
            ...
            IdenticalTwinsLine.init(this.ctx, points, this.lineWidth, this.scalingFactor)    
        } else {
            const nodeA = parent
            const nodeB = parent.marriagePartner
